...
public class FileDownloadedAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public FileDownloadedAdapter(Context context, List<FileLink> fileLinkList, Callback callback) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch (getItemViewType(position)){
            case TYPE_NORMAL:
                if(convertView == null){
                    view = LayoutInflater.from(context).inflate(R.layout.file_downloaded_item, null);
                ...
                if(fileLink.getIsFolder() == 'y'){      // 文件夹
                    ...
                    viewHolder.fileMsg.setText("文件下载完成");
                }
